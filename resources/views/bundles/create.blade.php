    ...
    <form action="{{ route('bundle.store') }}" method="POST">
        ...
        <div id="bundle-discounts" class="mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <button type="button" id="add-discount" class="btn btn-outline-primary">+ Add Discount</button>
            </div>
...
<style>
    ...
    h2 { font-weight: 600; color: #111827; }
    label { font-weight: 500; color: #374151; }
    .btn { border-radius: 8px; font-weight: 500; }
    .product-list div { margin-bottom: 6px; }
    .remove-discount { font-size: 0.9rem; }
</style>
@endpush
